      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {PORTALS.map((portal) => {
            ...
            return (
              <div key={portal.title} className="rounded-2xl border border-[#D5E9E6] bg-[#F8FCFB] p-5 hover:shadow-md transition-shadow">
                <div className="w-10 h-10 rounded-xl bg-[#E2F2F5] flex items-center justify-center mb-3">
...
const STATS = [
  {
    ...
    description: "Empowering mothers across Rwanda with dedicated maternal health tracking and education resources.",
    icon: Users,
    large: true,
  },
  {
    value: "500+",
    label: "Active Health Centers",
    description: "Facilities actively connected and reporting.",
    icon: Activity,
    large: false,
  },
  {
    ...
    description: "Setting new standards for immunization tracking in the region.",
    icon: CheckCircle2,
    large: false,
  },
];
...
function ImpactSection() {
  return (
    <section id="impact" className="py-10 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-6">
          <h2 className="text-2xl font-bold text-[#1D5052]">
            Our Growing Impact in Rwanda
          </h2>
          <p className="mt-1 text-sm text-[#54797C]">
            Tangible results driving a healthier tomorrow.
          </p>
        </div>
  ...
  return (
    <footer className="bg-[#1D5052] border-t border-white/10 py-8">
      <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <p className="text-xs text-white/40">© 2026 MotherHood Journey</p>
      </div>
    </footer>
  );
}
