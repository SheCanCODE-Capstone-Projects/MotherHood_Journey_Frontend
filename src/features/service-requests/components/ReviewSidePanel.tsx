            ...
            <div className="flex gap-2">
              ...
              {canEscalate && (
                <button
                  ...
                  disabled
                  title="Escalate not yet supported by the backend"
                  className="flex flex-1 items-center justify-center gap-2 rounded-lg border border-blue-300 px-4 py-2 text-sm font-semibold text-blue-700 opacity-50 cursor-not-allowed"
                >
